...
namespace ESP8266_TCP
{
  ...
  void ESP8266_WCS::_clearAuthenticationSettings()
  {
    _use_insecure = false;
  ...
  ESP8266_WCS::ESP8266_WCS() : WiFiClient()
  {
    _clear();
  ...
  ESP8266_WCS::ESP8266_WCS(const ESP8266_WCS &rhs) : WiFiClient(rhs)
  {
    *this = rhs;
    stack_thunk_add_ref();
  }
  ...
  ESP8266_WCS::ESP8266_WCS(ClientContext *client, const ESP8266_X509_List *chain, const PrivateKey *sk, int iobuf_in_size, int iobuf_out_size, const ESP8266_X509_List *client_CA_ta)
  {
    _clear();
    _clearAuthenticationSettings();
    stack_thunk_add_ref();
  ...
  ESP8266_WCS::ESP8266_WCS(ClientContext *client, const ESP8266_X509_List *chain, unsigned cert_issuer_key_type, const PrivateKey *sk, int iobuf_in_size, int iobuf_out_size, const ESP8266_X509_List *client_CA_ta)
  {
    _clear();
    _clearAuthenticationSettings();
    stack_thunk_add_ref();
  ...
  void ESP8266_WCS::setClientRSACert(const ESP8266_X509_List *chain, const PrivateKey *sk)
  {
    _chain = chain;
    _sk = sk;
  }

  void ESP8266_WCS::setClientECCert(const ESP8266_X509_List *chain, const PrivateKey *sk, unsigned allowed_usages, unsigned cert_issuer_key_type)
  {
    _chain = chain;
    _sk = sk;
  ...
  void ESP8266_WCS::setBufferSizes(int recv, int xmit)
  {
  ...
  bool ESP8266_WCS::stop(unsigned int maxWaitMs)
  {
  ...
  bool ESP8266_WCS::flush(unsigned int maxWaitMs)
  {
    (void)_run_until(BR_SSL_SENDAPP);
    return WiFiClient::flush(maxWaitMs);
  }

  int ESP8266_WCS::connect(IPAddress ip, uint16_t port)
  {
  ...
  int ESP8266_WCS::connect(const String &host, uint16_t port)
  {
    return connect(host.c_str(), port);
  }

  void ESP8266_WCS::_freeSSL()
  {
  ...
  bool ESP8266_WCS::_clientConnected()
  {
  ...
  size_t ESP8266_WCS::_write(const uint8_t *buf, size_t size, bool pmem)
  {
    if (!_secured)
  ...
  size_t ESP8266_WCS::write(Stream &stream)
  {
    if (!_secured)
      return ns_write(stream);
...
*/
  int ESP8266_WCS::_run_until(unsigned target, bool blocking)
  {
    if (!ctx_present())
    {
  ...
  bool ESP8266_WCS::_wait_for_handshake()
  {
    _handshake_done = false;
  ...
  bool ESP8266_WCS::setFingerprint(const char *fpStr)
  {
    int idx = 0;
    uint8_t c, d;
    uint8_t fp[20];
  ...
  bool ESP8266_WCS::setCiphers(const uint16_t *cipherAry, int cipherCount)
  {
    _cipher_list = nullptr;
  ...
  bool ESP8266_WCS::_connectSSL(const char *hostName)
  {
    ...
    {
#ifndef BEARSSL_SSL_BASIC
      br_ssl_client_set_single_ec(_sc.get(), _chain ? _chain->getX509Certs() : nullptr, _chain ? _chain->getCount() : 0, _sk->getEC(), _allowed_usages, _cert_issuer_key_type, br_ec_get_default(), br_ecdsa_sign_asn1_get_default());
#else
      _freeSSL();
  ...
  bool ESP8266_WCS::_installServerX509Validator(const ESP8266_X509_List *client_CA_ta)
  {
    if (client_CA_ta)
    {
      _ta = client_CA_ta;
  ...
  bool ESP8266_WCS::_connectSSLServerRSA(const ESP8266_X509_List *chain, const PrivateKey *sk, const ESP8266_X509_List *client_CA_ta)
  {
    _freeSSL();
    _oom_err = false;
  ...
  bool ESP8266_WCS::_connectSSLServerEC(const ESP8266_X509_List *chain,
                                        unsigned cert_issuer_key_type, const PrivateKey *sk,
                                        const ESP8266_X509_List *client_CA_ta)
  {
#ifndef BEARSSL_SSL_BASIC
    _freeSSL();
    _oom_err = false;
  ...
  int ESP8266_WCS::getLastSSLError(char *dest, size_t len)
  {
    int err = 0;
  ...
  bool ESP8266_WCS::probeMaxFragmentLength(const char *name, uint16_t port, uint16_t len)
  {
    IPAddress remote_addr;
    if (!WiFi.hostByName(name, remote_addr))
    {
    ...
    return ESP8266_WCS::probeMaxFragmentLength(remote_addr, port, len);
  }

  bool ESP8266_WCS::probeMaxFragmentLength(const String &host, uint16_t port, uint16_t len)
  {
    return ESP8266_WCS::probeMaxFragmentLength(host.c_str(), port, len);
  }
  ...
  bool ESP8266_WCS::probeMaxFragmentLength(IPAddress ip, uint16_t port, uint16_t len)
  {
  ...
  bool ESP8266_WCS::setCACert(const uint8_t *pk, size_t size)
  {
    _axtls_ta = nullptr;
    _axtls_ta = std::shared_ptr<ESP8266_X509_List>(new ESP8266_X509_List(pk, size));
    _ta = _axtls_ta.get();
    return _ta ? true : false;
  }

  bool ESP8266_WCS::setCertificate(const uint8_t *pk, size_t size)
  {
    _axtls_chain = nullptr;
    _axtls_chain = std::shared_ptr<ESP8266_X509_List>(new ESP8266_X509_List(pk, size));
    _chain = _axtls_chain.get();
    return _chain ? true : false;
  }

  bool ESP8266_WCS::setPrivateKey(const uint8_t *pk, size_t size)
  {
    _axtls_sk = nullptr;
  ...
  uint8_t *ESP8266_WCS::_streamLoad(Stream &stream, size_t size)
  {
  ...
  bool ESP8266_WCS::loadCACert(Stream &stream, size_t size)
  {
...
#pragma GCC diagnostic pop
  ...
  bool ESP8266_WCS::loadCertificate(Stream &stream, size_t size)
  {
    uint8_t *dest = _streamLoad(stream, size);
    bool ret = false;
    if (dest)
...
#pragma GCC diagnostic pop
  ...
  bool ESP8266_WCS::loadPrivateKey(Stream &stream, size_t size)
  {
    uint8_t *dest = _streamLoad(stream, size);
    bool ret = false;
    if (dest)
...
#pragma GCC diagnostic pop
  ...
  bool ESP8266_WCS::connectSSL(bool verify)
  {
    ...
    bool ret = _connectSSL(_host_name.c_str());
    if (ret)
      _secured = true;
    return ret;
  }
